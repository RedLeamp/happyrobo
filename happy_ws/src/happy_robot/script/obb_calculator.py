...
class OBBCalculator:
    def __init__(self):
        ...
        self.frontLeft_scan_topic = "/cygbot/scan/2d/1"
        self.frontRight_scan_topic = "/cygbot/scan/2d/2"
        self.frontLeft_left_scan_topic = "/cygbot/scan/2d/5"
        self.frontRight_right_scan_topic = "/cygbot/scan/2d/6"
        self.frontLeft_points_topic = "/cygbot/point/3d/1"
        self.frontRight_points_topic = "/cygbot/point/3d/2"
        self.frontLeft_left_points_topic = "/cygbot/point/3d/5"
        self.frontRight_right_points_topic = "/cygbot/point/3d/6"
        self.obb_topic = "/obb"
    ...
    def project_filtered_points(self, points, projected_points):
        ...
        for point in cloud:
            if (point[2] >= self.LiDAR_height-0.1): # Z 0.235m 이상만
